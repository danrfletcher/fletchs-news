...
describe('POST Requests', () => {
    ...
    describe('/api/articles', () => {
        test('/api/articles 201: responds with the posted article including its preset properties', () => {
            return request(app)
            .post('/api/articles')
            .send({
                author: "butter_bridge",
        ...
        test('/api/articles 201: ignores additional properties present in the request body', () => {
            return request(app)
            .post('/api/articles')
            .send({
                author: "butter_bridge",
        ...
        test('/api/articles 201: provides a default image if one is not included', () => {
            return request(app)
            .post('/api/articles')
            .send({
                author: "butter_bridge",
        ...
        test('/api/articles 400: returns bad request if any object properties are missing in the request body', () => {
            return request(app)
            .post('/api/articles')
            .send({
                title: "Why Frog's Legs are Becoming Britain's New Favourite Food",
        ...
        test('/api/articles 404: returns a 404 error if the author is not a valid username', () => {
            return request(app)
            .post('/api/articles')
            .send({
        ...
        test('/api/articles 404: returns a 404 error if the topic does not exist', () => {
            return request(app)
            .post('/api/articles')
            .send({
                author: "butter_bridge",
